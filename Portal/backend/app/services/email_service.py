...
def send_upload_link(
    *,
    ...
    text = (
        ...
        f"Abre este enlace desde cualquier dispositivo (celular, tablet o computadora):\n\n"
        f"  {upload_url}\n\n"
...
<body style="font-family:Arial,sans-serif;max-width:520px;margin:auto;padding:32px;color:#1e293b">
  ...
  <p>Tu enlace para subir los archivos de identidad está listo. Ábrelo desde cualquier dispositivo.</p>
